...
params = ModeParams(
        ...
        ell_max = 10, # max spherical harmonic degree
        ...
        n_modes = 400, # number of modes to compute and return
        st_target_per_yrs = 100, # frequency that shift invert will target
        )
