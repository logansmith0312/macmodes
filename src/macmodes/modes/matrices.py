...
def numpy2petsc(A_np: np.ndarray[complex],
                ...
                A_petsc: PETSc.Mat,
                B_petsc: PETSc.Mat) -> None:
    '''takes numpy.ndarray and passes data to petsc4py csr matrix objects'''
    ...
    # chagne this bacl to casting to scipy first --> maybe more efficient?
    for k in range(n_total):
        A_petsc.setValue(k, k, A[k,k])
        B_petsc.setValue(k, k, B[k,k])
